...
import { checkOtp, login } from '../../services/userServices';
      ...
      <div className='card-view'>
        <form>
          ...
          <div className='margin-top--small'>
            <TextInput className='text-input-otp' onChange={(e: any) => setValue(e.target.value)} value={value} />
          </div>
          <div className='timer'>
            <Progress
              width={65}
          ...
          <div className='btn-row'>
            <button className='btn margin-top--large' onClick={(e: any) => sendOtp(e)} disabled={value.length !== 6}>
              Submit
            </button>
          </div>
        </form>
